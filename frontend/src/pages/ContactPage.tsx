//TODO:Contact page to be desingned
      ...
      <div className="grid w-full max-w-5xl gap-8 p-6 md:grid-cols-2">
        ...
        <div>
          ...
          <p className="mb-6 text-gray-600">
            Have questions about submissions, technical issues, or
            collaborations? Fill out the form or reach us directly.
          </p>
          <div className="space-y-3 text-gray-700">
            ...
            <p>
              <strong>Address:</strong> Research Hub, Mumbai, India
            </p>
          </div>
